...
class Imotinet1Spider(CrawlSpider):
    name = 'imotinet1'
    allowed_domains = ['imoti.net']
    start_urls = ['https://imoti.net/bg/obiavi/r/prodava/bulgaria/?sid=gEiBeA']
    ...
    def parse_item(self, response):
        ...
        yield {
            ...
            'construction': article.xpath(
                "./aside/section/div[@class='simple-table']/table/tbody/tr[4]/td[2]/text()").get(),
            ...
            'price': article.xpath(
                "./aside[@class='info-sidebar']/section/header/div[@class='big-price']/strong/text()").get(),
            # 'url': response.url, njama nujda ot linka
        }
